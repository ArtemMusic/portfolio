...
const langArr = {
  "title" : {
    "ru" : "Новостной сайт для блогов",
    "en" : "News site for blogs"
  },
  "subtitle" :  {
    "en": "Read and post news, share events, comment on posts and put likes. <br>PHP8, Laravel9, SQL/MySql, Html/Css, Docker, MailTrap, Jobs <br>yourpost.online",
    "ru": "Читайте и выкладывайте новости, делитесь событиями, комментируйте посты и ставьте лайки.<br>PHP8, Laravel9, SQL/MySql, Html/Css, Docker, MailTrap, Jobs <br>yourpost.online",
  },
  "crud" :  {
    "ru": "CRUD из бд",
    "en": "CRUD from db",
  ...
  "purposetext" :  {
    "ru": "Продвинутое развитие ключевых навыков в web разработке, работе с базами данных, паттернах программирования и проектирования, автодеплой и поддержание сайта на хостинге. Опыт во front-end и back-end разработке нагруженных программных продуктах.",
    "en": "Advanced development of key skills in web development, working with databases, patterns programming and design, auto-deploy and maintenance of the site on the hosting. Experience in front-end and back-end development of loaded software products.",
  },
  "purpose2" :  {
  ...
  "purpose2text2" :  {
    "ru": "GitHub страница: <a href='https://github.com/ArtemMusic/BlogSite' target='_blank'><i class='fa-brands fa-github'></i></a>",
    "en": "GitHub page: <a href='https://github.com/ArtemMusic/BlogSite' target='_blank'><i class='fa-brands fa-github'></i></a>",
  },
  "purpose2text3" :  {
    "ru": "Автодеплой docker, верификая по почте, документация, система очередей, лайки и комментарии, авторизация и система ролей, CRUD постов и взаимодействие с базой данных, паттерны MVC и SOLID, bootstrap, админпанель, валидация форм, фильтрация, пагинация, JWT, REST.",
    "en": "Docker auto-deploy, verification by mail, documentation, queuing system, likes and comments, authorization and role system, CRUD posts and interaction with the database, MVC patterns and SOLID, bootstrap, admin panel, form validation, filtering, pagination, JWT, REST.",
  },
  "purpose3" :  {
    "ru": "Освоено/развито",
